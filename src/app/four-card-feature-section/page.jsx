    ...
    return (
        <div className="flex flex-col font-poppins space-y-10 text-[#697077] text-[15px]">
            ...
            <div className="flex flex-col space-y-10 lg:flex-row lg:space-x-10 lg:space-y-0 lg:justify-center lg:items-center">
                <div className="bg-white rounded-lg space-y-5 p-5 border-t-4 border-t-[#45d3d3] w-full h-52 lg:w-80">
                    <div>
                ...
                <div className="flex flex-col justify-center items-center space-y-10">
                    <div className="bg-white rounded-lg space-y-5 p-5 border-t-4 border-t-[#ea5353] w-full h-52 lg:w-80">
                        <div>
                    ...
                    <div className="bg-white rounded-lg space-y-5 p-5 border-t-4 border-t-[#fcaf4a] w-full h-52 lg:w-80">
                        <div>
                            <span>Karma</span>
                ...
                <div className="bg-white rounded-lg space-y-5 p-5 border-t-4 border-t-[#549ef2] w-full h-52 lg:w-80">
                    <div>
